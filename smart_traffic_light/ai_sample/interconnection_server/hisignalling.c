...
void UartSendRead(int fd, refuseClassification refuseType,int senddata)
{
    /*
     * 测试buffer
     * Test buffer
     */
    unsigned char writeBuffer2[4] = {1, senddata, 1, 2};
    //unsigned char writeBuffer3[4] = {1, 1, 1, 1};
    unsigned char writeBuffer4[4] = {1, senddata, 1, 2};
    unsigned char writeBuffer5[4] = {1, senddata, 1, 2};
    unsigned char writeBuffer6[4] = {1, senddata, 1, 2};
    unsigned char writeBuffer7[4] = {1, senddata, 1, 2};
    unsigned char writeBuffer8[4] = {1, senddata, 1, 2};
    unsigned char writeBuffer9[4] = {1, senddata, 1, 2};
    unsigned char readBuff[16] = {0};
