...
#define IOT_GPIO_INDEX_10 11
#define IOT_GPIO_INDEX_11 10
...
#define AUTO_MODULE_LIGHT_ON_TIME   (10)
#define DATA_OUT_OF_BOUND (-1)
#define AUTO_MODULE_LIGHT_ON_TIME_10_SECOND   (10)
hi_u8 number_miaow=0x55;
hi_u8 number_miao_judger=0x33;
/*if(number_miaow>number_miao_judger)
     {
     #define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_TIME (0x22) //修改-wjy
     }
    
if(1)
     {
     #define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_TIME (0x66) //修改-wjy
     }
*/

//#define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_TIME (0x55) //修改-wjy
//#define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_TIME (number_miaow_1) (number_miaow_1)
//#define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND   (AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_TIME)//修改-wjy //锚1，源代码处
//#define AUTO_MODULE_LIGHT_ON_TIME_30_SECOND  (12)//锚（回复点）（原代码）
//static int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_static_int=12;
//unsigned char AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_unsigned_char=12

int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_whole_control=12;
//int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge=12;
//unsigned char AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_char=12;
//int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int=12;
//int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1=12;
int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge;
unsigned char AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_char;
int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int;
int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1;
void AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_define(int whole_control);
//修改-1
...
//static int timer6Count = AUTO_MODULE_LIGHT_ON_TIME_30_SECOND;  //锚3，源代码处(需要static int类型)//源代码位置
unsigned char timer6Count=12;//改动-20230712
//int timer6Count=12;//如此改动，也不报错
...
/*接受数据并改变
unsigned int receivedatachange(unsigned char receivedata)
{
    int change = 0;
    change = receivedatachange(2);
...
void AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_define(int whole_control)
{
    int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge= whole_control;
    unsigned char AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_char= unsigned char(whole_control);
    int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int= whole_control;
    int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1= whole_control;
}
//修改-2
...
static void RedOledLedLigthTimeShowNum9(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:9 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:9 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum8(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:8 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:8 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum7(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:7 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:7 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum6(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:6 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:6 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum5(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:5 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:5 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum4(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:4 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:4 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum3(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:3 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:3 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum2(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:2 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:2 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum1(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:1 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:1 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void RedOledLedLigthTimeShowNum0(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
// 绿色
static void GreenOledLedLigthTimeShowNum9(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:9 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:9 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum8(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:8 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:8 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum7(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:7 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:7 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum6(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:6 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:6 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum5(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:5 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:5 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum4(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:4 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:4 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum3(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:3 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:3 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum2(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:2 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:2 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
static void GreenOledLedLigthTimeShowNum1(void)
{
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:1 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:0 R:1 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
int OledLedLightHumanReckonShow(int timeCount)
{
    ...
    //int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge=12;
    if (timeCount == AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge - 1) { /* 1: 0ffset */ //锚4，源代码处（需要static int 类型）（修改了）
        sta = HI_FALSE;
    }
...
//修改
int OledGreenLightHumanReckonShow(int timeCount)
{
    int ret = 0;
    unsigned char showTimeCount[4] = {0};
    unsigned char beepStatus[2] = {0};
   ...
   //  int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge=12;
    if (timeCount == AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_judge - 1) { /* 1: 0ffset */  //锚5，源代码处(修改了)
        sta = HI_FALSE;
    }
    if (timeCount < AUTO_MODULE_LIGHT_ON_TIME_10_SECOND && sta == HI_FALSE) {
        sta = HI_TRUE;
        OledShowStr(OLED_X_POSITION_80, OLED_Y_POSITION_7,
                    space, OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
    OledShowStr(OLED_X_POSITION_80, OLED_Y_POSITION_7,
                showTimeCount, OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
...
void YellowTimeCount6(void)
{
    ...
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:3 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:3 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
void YellowTimeCount4(void)
{
    ...
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:2 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:2 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
void YellowTimeCount2(void)
{
    ...
    if (GetKeyStatus(OC_BEEP_STATUS) == BEEP_ON) {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:1 R:0 B:1 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    } else {
        OledShowStr(OLED_X_POSITION_0, OLED_Y_POSITION_7,
                    "G:0 Y:1 R:0 B:0 ", OLED_DISPLAY_STRING_TYPE_1); /* 0, 7, xx, 1 */
    }
}
...
void RedLedLightOnFiveSecond(unsigned int timeCount)
{
    ...
    if (timeCount < AUTO_MODULE_LIGHT_ON_TIME) {
        OledLedLightHumanReckonShow(timeCount);
...
void GreenLedLightOnFiveSecond(unsigned int timeCount)
{
    ...
    if (timeCount < AUTO_MODULE_LIGHT_ON_TIME) {
       //GreenOledLedLigthReckonByTimeShow(timeCount);
        OledGreenLightHumanReckonShow(timeCount);
    }
    if (timeCount == COUNT_RESET) {
        GpioControl(IOT_GPIO_INDEX_11, IOT_GPIO_INDEX_11, IOT_GPIO_DIR_OUT, IOT_GPIO_VALUE0, IO_FUNC_GPIO_OUT);
...
void AutoModeCountReset(void)
{
    ...
    timer6Count = SetTimeCount(AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_char);//锚6，源代码处 （需要unsigned char类型）
    ...
    TrafficLightTimer.Timer6Count = SetTimeCount(AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_char); //锚7，源代码处（需要unsigned char类型）
...
//int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int=12;
    if (normalTimeCount < AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int) { //锚8，源代码处，需要unsigned char 类型
...
void Timer2Callback(int arg)
{
    ...
    if (timer6Count == LAMP_FLASHING_TIME_RESET_0) {
        //int AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1=12;
        TrafficLightTimer.Timer6Count = AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1;//锚9，源代码处（需要 int 类型）
        timer6Count = AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_int1;//锚10，源代码处（需要static int 类型）
        return;
    }
...
{
    AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_define(AUTO_MODULE_LIGHT_ON_TIME_30_SECOND_whole_control);//修改-3
    osThreadAttr_t attr;
    IoTWatchDogDisable();
